...
export default function Carousels() {
  ...
  const filteredCarousels = carousels.filter((carousel) => {
    ...
    const matchesStatus =
      statusFilter === "all" || carousel.status === statusFilter;
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-1 flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant={
                          carousel.status === "active" ? "default" : "secondary"
                        }
                      >
                        {carousel.status}
                      </Badge>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem
                        onClick={() =>
                          navigate(`/carousels/${carousel.carousel_id}`)
                        }
                      >
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          handleDeleteCarousel(carousel.carousel_id)
                        }
