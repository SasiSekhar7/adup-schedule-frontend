        ...
        <Card key={campaign.campaign_id}>
          ...
          <CardContent>
            ...
            <div className="flex gap-2 mb-4">
              <Badge
                variant={campaign.requires_phone ? "default" : "secondary"}
              >
                {campaign.requires_phone
                  ? "Phone Required"
                  : "No Phone Required"}
              </Badge>
              <Badge
                variant={campaign.requires_questions ? "default" : "secondary"}
              >
                {campaign.requires_questions
                  ? "Questions Required"
